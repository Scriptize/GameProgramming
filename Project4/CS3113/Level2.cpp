...
Level2::Level2(Vector2 origin,const char*bg):Scene(origin,bg){}
...
void Level2::initialise() {
    ...
    enemy = new AIEntity({mOrigin.x+200,mOrigin.y-200},{100,100},"assets/enemy.png",ENEMY_FOLLOWER,120);
...
void Level2::update(float dt){
    ...
    if(mGameState.xochitl->getPosition().x>800)mGameState.nextSceneID=3;
}
void Level2::render(){
