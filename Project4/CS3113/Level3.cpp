...
Level3::Level3(Vector2 origin,const char*bg):Scene(origin,bg){}
...
void Level3::initialise() {
    ...
    enemy = new AIEntity({mOrigin.x+200,mOrigin.y-200},{100,100},"assets/enemy.png",ENEMY_FLYER,120);
...
void Level3::update(float dt){
    ...
    if(mGameState.xochitl->getPosition().x>800)mGameState.nextSceneID=4;
}
void Level3::render(){
